...
public class SearchGrader implements Runnable {
    ...
    public void runTest(int i, String file, String desc, GeographicPoint start, GeographicPoint end) {
        ...
        judgeBFSAndVerticesAndVertex(i, graph, corr, start, end);
    }
     ...
     * @param end    The point to end at
     */
    private void judgeBFSAndVerticesAndVertex(int i, MapGraph result, CorrectAnswer corr, GeographicPoint start, GeographicPoint end) {
